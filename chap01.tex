...
\chybi{uvod do sekce - Zavedeme termíny, připomínáme pipu, další využití, úvod do češtiny. přidat příklady}
...
\chybi{\defineterm{Lemma}} \todo{A form from a lexeme chosen by convention (e.g.,
...
\chybi{\defineterm{Lexeme}}\todo{An abstract entity; the set of all forms related by
...
\chybi{ukázka, jak by vypadala pipa, která udělá extrakci. Zmínit, že to není to samé jako nějaká forma summary, že klisifikujeme z vět ne z článků, přidat další motivaci.}
...
\chybi{něco o tom, že pořadí slov je skoro náhodné, ale zase ne až tak úplně, jak moc se mění pořádek slov pro noun phrases?}
