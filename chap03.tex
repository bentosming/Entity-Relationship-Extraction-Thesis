...
The objective is to use distant supervision\todo{link zpátky} to create a Relationship Extraction dataset for the Czech language. This section is a brief summary for easier orientation in this chapter. Each of these paragraphs is a teaser for one section of this chapter.
...
\subsection{Python}
\chybi{Python je rozšířený, asi nejčastější u AI/ML.}

\chybi{Má spoustu fajn knihoven na všechno (pandy, numpy, scikit, tesorflow, pytorch, transformers ...)}

\todo{zmiň pandy a numpy a tak}
\subsection{Spark}
\chybi{Umožňuje práci s clusterem}

\subsection{MorphoDiTa}
\chybi{Nepsat o tom, jak funguje uvnitř}
...
\chybi{Webb app, zaměřeno na data}
