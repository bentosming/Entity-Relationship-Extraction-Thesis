...
\chybi{nemá nic oficiálního .. napsat, že samo osobě nemít oficiální je hloupé? že na nlpprogres se reportuje .. }

\subsubsection{CERED}

\chybi{jakou metriku použít? Micro? Macro? Použít tu, co u tacredu nemá smysl..}
...
\chybi{matching the blanks .. psát? i když se neimplementuje? Njaké jiné články?}
